...
(function () {
  ...
  window.__FUNDADRON__ = {
    ...
    config: {
      /* ⚠️ EAbNI_lzoNFBTaDOdRJl_jPPPpTzdHh20r2Jqu8TfwW64RRtK7pZz8LJn-vdPj3gl6gL4KdSj_9R-GTix tu Client ID de PayPal (cuenta Business → developer.paypal.com)
         Mientras esté vacío, el carrito mostrará un aviso de configuración. */
      paypalClientId: "AaTXbFnrhlMbry8-i0lCqUCPhPeoXw1o7npS3gKMzV2AoZQZSY9d-B2M9PoFet58wh27lwtTw0cvaWiK",
      currency: "EUR",
      /* Envío */
      shippingPickup: 3.95,         /* punto de recogida / locker InPost */
      shippingHome: 4.95,           /* entrega a domicilio */
    ...
    faqs: [
      {
        ...
        a: "Imprimimos y preparamos tu pedido en 24-48 h. Puedes elegir recogida en un punto o locker InPost (3,95 €, ~3 días, con aviso por SMS) o entrega a domicilio (4,95 €, 24-72 h). Envío gratis a partir de 49 €. Siempre con seguimiento."
      },
      {
